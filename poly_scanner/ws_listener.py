...
class WebSocketListener:
    ...
    async def _subscribe(self, ws: websockets.WebSocketClientProtocol) -> None:
        ...
        Max 500 assets per connection (Polymarket undocumented limit).
        ...
        # Polymarket limit: 500 per connection
        # First subscription uses "type", subsequent use "operation"
        chunk_size = 200
        for i in range(0, len(all_token_ids), chunk_size):
            ...
            if i == 0:
                ...
                # Add more assets to existing subscription
                msg = json.dumps({
                    "assets_ids": chunk,
                    "operation": "subscribe",
                })
    ...
    async def _handle_message(self, raw: str | bytes) -> None:
        ...
        # WS can send a single event or an array
        ...
        for event in events:
            ...
            # last_trade_price = individual trade event
            ...
            # book, price_change, tick_size_change — skip silently
    ...
    def _parse_trade(self, data: dict) -> Trade | None:
        ...
        try:
            ...
            # Note: market channel does NOT provide wallet addresses
            wallet = "unknown"
